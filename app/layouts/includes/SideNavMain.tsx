                    ...
                    <div className='lg:block hidden border-b lg:ml-2 mt-2'>
                        <div className='lg:block hidden text-[11px] text-gray-500'>
                            <p className='pt-4 px-2'>
                                About Newsroom Toktok Shop Contact Careers
                                ByteDance
                            </p>
                            <p className='pt-4 px-2'>
                                Toktok for Good Advertise Developers
                                Transparency Toktok Rewars Toktok Browse Toktok
                                Embeds
                            </p>
                            <p className='pt-4 px-2'>
                                Help Safety Terms Privacy Creator Portal
                                Community Guidelines
                            </p>
                            <p className='pt-4 px-2'>© 2024 Toktok</p>
                        </div>
                    </div>
                </div>
            </div>
